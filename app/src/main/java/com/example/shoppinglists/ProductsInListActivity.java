...
public class ProductsInListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = rootRef.child("List");
    ...
    protected void onStart() {
        ...
        ChildEventListener childEventListener = new ChildEventListener() {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                Products pro = dataSnapshot.getValue(Products.class);
                Toast.makeText(ProductsInListActivity.this, "onChildChanged: " + pro.getProductName(), Toast.LENGTH_SHORT).show();
            ...
            public void onChildRemoved(DataSnapshot dataSnapshot) {
                ...
                Products pro = dataSnapshot.getValue(Products.class);
                Toast.makeText(ProductsInListActivity.this, "onChildRemoved: " + pro.getProductName(), Toast.LENGTH_SHORT).show();
            ...
            public void onChildMoved(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                Products pro = dataSnapshot.getValue(Products.class);
                Toast.makeText(ProductsInListActivity.this, "onChildMoved: " + pro.getProductName(), Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ProductsInListActivity.this, "Failed to load Message.", Toast.LENGTH_SHORT).show();
            }
        };
